...
async function register(req, res) {
    ...
    const expectedUser = await db.query('SELECT * FROM users WHERE email = $1::text', [email])
    ...
    await db.query(`INSERT INTO users (first_name, second_name, email, password_hash) VALUES($1, $2, $3, $4)`,
